...
class content extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('City.Content.View');
	...
	{
		$this->auth->restrict('City.Content.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_city())
			{
				...
				redirect(SITE_AREA .'/content/city');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('City.Content.Edit');
		...
		{
			$this->auth->restrict('City.Content.Delete');
