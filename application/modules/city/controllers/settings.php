...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('City.Settings.View');
	...
	{
		$this->auth->restrict('City.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_city())
			{
				...
				redirect(SITE_AREA .'/settings/city');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('City.Settings.Edit');
		...
		{
			$this->auth->restrict('City.Settings.Delete');
