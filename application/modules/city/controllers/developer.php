...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('City.Developer.View');
	...
	{
		$this->auth->restrict('City.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_city())
			{
				...
				redirect(SITE_AREA .'/developer/city');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('City.Developer.Edit');
		...
		{
			$this->auth->restrict('City.Developer.Delete');
