...
$num_columns	= 8;
$can_delete	= $this->auth->has_permission('City.Content.Delete');
$can_edit		= $this->auth->has_permission('City.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/city/edit/' . $record->cid, '<span class="icon-pencil"></span>' .  $record->city); ?></td>
				<?php else : ?>
