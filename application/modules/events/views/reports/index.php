...
$num_columns	= 16;
$can_delete	= $this->auth->has_permission('Events.Reports.Delete');
$can_edit		= $this->auth->has_permission('Events.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/events/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->fmid); ?></td>
				<?php else : ?>
