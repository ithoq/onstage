...
$num_columns	= 16;
$can_delete	= $this->auth->has_permission('Events.Developer.Delete');
$can_edit		= $this->auth->has_permission('Events.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/events/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->fmid); ?></td>
				<?php else : ?>
