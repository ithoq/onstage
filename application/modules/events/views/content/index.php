...
$num_columns	= 16;
$can_delete	= $this->auth->has_permission('Events.Content.Delete');
    ...
    <?= $sel_cities ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/events/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->fmid); ?></td>
				<?php else : ?>
