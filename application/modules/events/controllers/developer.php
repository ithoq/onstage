...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Events.Developer.View');
	...
	{
		$this->auth->restrict('Events.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_events())
			{
				...
				redirect(SITE_AREA .'/developer/events');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Events.Developer.Edit');
		...
		{
			$this->auth->restrict('Events.Developer.Delete');
